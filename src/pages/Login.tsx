...
function Login() {
  ...
  return (
    <div className=' bg-[url("/bg-01.jpg")]   bg-center bg-cover w-screen h-[100dvh] relative z-10 flex justify-center items-center content-center before:content-[""] before:absolute before:inset-0 before:block before:bg-gradient-to-r before:from-cyan-500 before:to-fuchsia-500 before:opacity-75 before:z-[-5]'>
        <div className=' bg[url("/bg-01.jpg")]   bg-center bg-cover sm:bg-gray-100 w-screen sm:w-3/5 md:w-1/3 pt-20 min-w-fit h-screen sm:h-[90%] sm:rounded-md flex flex-col items-center shadow-[0px_15px_60px_20px] shadow-[#61616175]'>
            ...
            <div className=' py-3 flex-grow flex flex-col justify-between'>
                <div className=' text-slate-800 sm:text-slate-400 text-xs font-medium'>Or login with</div>
                ...
                <div className=' mt-[6vh] text-center text-slate-800 sm:text-slate-500 text-xs font-medium hover:cursor-pointer'>Sign Up</div>
            </div>
        </div>
    </div>
  )
